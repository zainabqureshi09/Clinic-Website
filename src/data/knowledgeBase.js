...
export const knowledgeBase = [
  ...
  },
  {
    ...
    answer: 'We offer comprehensive healthcare services including: General Medicine (Family Medicine & Primary Care, Chronic Disease Management, Children & Adult Care, Acute Care for Illnesses, Preventive Health & Annual Physicals, Vaccinations & Immunizations, Women\'s Health, Minor Procedures) and Nephrology (Chronic Kidney Disease – Stages 1–5, Hypertension Management, Kidney Stones Prevention, Electrolyte Disorders, Dialysis Support). Our multilingual staff serves patients in English, Tamil, Hindi, Urdu, Sylheti, Bengali, and Gujarati.',
    keywords: ['services', 'treatments', 'offer', 'specialties', 'medical'],
  },
  {
    id: 5,
    category: 'services',
    question: 'Do you provide nephrology services?',
    answer: 'Yes, we offer comprehensive nephrology services including: Chronic Kidney Disease management (Stages 1-5), Hypertension Management, Kidney Stones Prevention, Electrolyte Disorders, and Dialysis Support.',
    keywords: ['nephrology', 'kidney', 'dialysis', 'hypertension'],
  },
  {
    id: 6,
    category: 'doctors',
  ...
  },
  {
    ...
    answer: 'Yes, Dr. Pooja Kharbanda is our Nephrologist and Internist specializing in Chronic Kidney Disease (Stages 1-5), Hypertension Management, Kidney Stones Prevention, and Electrolyte Disorders.',
