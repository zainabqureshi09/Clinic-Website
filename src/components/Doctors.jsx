...
const Doctors = () => {
  ...
  return (
    <section id="doctors" className="relative py-24 overflow-hidden bg-white dark:bg-slate-950">
      {/* Animated Orbs */}
      <motion.div
        className="absolute top-1/4 right-1/4 w-96 h-96 bg-emerald-100/50 dark:bg-emerald-900/20 rounded-full blur-3xl"
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.3, 0.5, 0.3],
        }}
      ...
      />
      <motion.div
        className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-teal-100/50 dark:bg-teal-900/20 rounded-full blur-3xl"
        animate={{
          scale: [1.2, 1, 1.2],
          opacity: [0.3, 0.5, 0.3],
        }}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <div className="relative h-full rounded-2xl overflow-hidden bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 shadow-sm hover:shadow-2xl transition-all">
                ...
                <div className="relative h-72 overflow-hidden">
                  ...
                  {/* Overlay Gradient */}
                  <div 
                    className="absolute inset-0 bg-gradient-to-t from-white dark:from-slate-900 via-transparent to-transparent opacity-80"
                  />
                ...
                <div className="p-6">
                  ...
                  {/* Name */}
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white mt-1 mb-2 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">
                    {doctor.name}
                  </h3>
                ...
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none">
                  <div className="absolute -inset-1 bg-gradient-to-r from-emerald-500/10 to-teal-500/10 dark:from-emerald-500/5 dark:to-teal-500/5 rounded-2xl blur-xl" />
                </div>
              </div>
            </motion.div>
          ))}
        ...
        >
          <p className="text-gray-500 dark:text-gray-400 mb-4">Want to see more specialists?</p>
          <motion.a
            href="#contact"
            className="inline-flex items-center space-x-2 text-emerald-600 dark:text-emerald-400 font-medium hover:text-emerald-700 dark:hover:text-emerald-300 transition-colors"
            whileHover={{ x: 5 }}
          >
